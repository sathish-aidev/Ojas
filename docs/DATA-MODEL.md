...
6. **Monthly P&L:** Received from Cult (typed Partner Share) − TDS + Total PT − owner bills − cash given to supervisor − PAID payroll netPay (base + trainer PT share). Leasing EMI is ignored. Supervisor spends are tracked but not deducted again. Gym start is January 2026. See `docs/REVENUE.md`.
