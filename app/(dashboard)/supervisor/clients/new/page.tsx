...
export default async function NewSupervisorClientPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Add a client with PT package and payment details</p>
      </div>
      <AddClientWithPTForm
        trainers={trainers.map((t) => ({ id: t.id, name: t.user.name }))}
        redirectTo="/supervisor/clients"
        alwaysOpen
      />
    </div>
  );
